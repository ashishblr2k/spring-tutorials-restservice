...
import bookmarks.SpringTutorialsRestserviceApplication;
...
@SpringBootTest(classes = SpringTutorialsRestserviceApplication.class)
@WebAppConfiguration
public class BookmarkRestControllerHateoasTest {
    ...
    public void readSingleBookmark() throws Exception {
        mockMvc.perform(get("/" + userName + "/bookmarkshateoas/"
    ...
    public void createBookmark() throws Exception {
        ...
        this.mockMvc.perform(post("/" + userName + "/bookmarkshateoas")
                .contentType(contentType)
